...
const BookCard: React.FC<BookCardProps> = ({
  ...
  return (
    <div className="relative bg-white/50 rounded-lg shadow-md p-4 transition-shadow duration-300 hover:shadow-xl h-[450px] flex flex-col  gap-4">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-gray-500">Genre: {book.subjects[0] || "Unknown"}</p>
      </div>
    </div>
  );
};
